# Description: This file contains the utility functions for the chatbot.
# reference: https://github.com/webpilot-ai/ChatLongDoc
...
def store_info(text, memory_path, chunk_sz = 700, max_memory = 100000):
	info = []
	text = text.replace("\n", " ").split()
